...
def train(args):
    ...
    for epoch in range(1, args.epochs + 1):
        ...
        wandb.log({
                "epoch": epoch,
                "train_loss(dice+bce)": loss,
                "test_dice_mean": test_measure_mean,
                "test_dice_std": test_measure_std,
...
def get_args():
    ...
    parser.add_argument(
        ...
        "--learning-rate-scheduler-minimum", type=float, default=1e-15, dest="lrs_min"
    )
    parser.add_argument(
